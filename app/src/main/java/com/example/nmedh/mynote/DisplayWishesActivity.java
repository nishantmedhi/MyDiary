...
public class DisplayWishesActivity extends Activity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(DisplayWishesActivity.this,MainActivity.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_wishes2);
        ...
        newentry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(i);
                DisplayWishesActivity.this.finish();
            }
        });
    ...
    private void refreshData() {
        ...
        for (int i = 0; i < wishesFromDB.size(); i++){
            ...
            String Image_Url=wishesFromDB.get(i).getImageUri();

            //Bitmap image = wishesFromDB.get(i).getImage();
    ...
    public class WishAdapter extends ArrayAdapter<MyWish> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if ( row == null || (row.getTag()) == null){
                ...
                holder.mylayout = (RelativeLayout) row.findViewById(R.id.relativelayout);
                //holder.mImage = (ImageView) row.findViewById(R.id.thumbnail);
                ...
                //holder.empty = (TextView) row.findViewById(R.id.empty);
                //holder.empty.setText("Diary empty");
            }

            holder.myWish = getItem(position);

            Log.v("MainaClick",holder.myWish.getImageUri()+"...");

            holder.mTitle.setText(holder.myWish.getTitle());
            holder.mDate.setText(holder.myWish.getRecordDate());
            //holder.mImage.setImageBitmap(holder.myWish.getImage());
            //holder.mImage.setImageDrawable(holder.myWish.getImageView());
            ...
            holder.mylayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String image = finalHolder.myWish.getImageUri();
                    //Drawable image = finalHolder.myWish.getImageView();
